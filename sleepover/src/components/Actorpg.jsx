      ...
      <div className="z-10 relative">
        ...
        <div className="mt-[12vh] flex flex-col items-center gap-4">
            ...
            {camReady && (
              <div style={{
                ...
                <span style={{
                  ...
                  background: callStatus === "connected" ? "#3db87a" : "#e05c7a",
                  display: "inline-block",
                }} />
                {callStatus === "connected" ? "the guesser can see you nowwww" : "CAM ON"}
              </div>
            )}
          </div>
          ...
          {!isReady ? (
            ...
            <p style={{ color: "#3db87a", fontWeight: 700 }}>you are set as ready!</p>
          )}
        </div>
